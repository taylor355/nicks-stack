#!/usr/bin/env python3
# ==========================================================================
# Taylor AI Platform — Composio Sessions bootstrap  (v1.1.1)
# ==========================================================================
...
def activate(url: str, transport: str) -> bool:
...
def cmd_init(args) -> int:
    ...
    key = _api_key()
    if not key:
        teardown(f"{KEY_ENV} not resolvable")
        return 1
...
def cmd_status(args) -> int:
    ...
    if args.json:
        ...
        return 0 if data["mcp_url_present"] and data["scope_ok"] else 1
